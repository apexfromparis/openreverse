...
SignatureRecord SignatureEngine::Generate(const std::vector<Instruction>& instructions,
                                          size_t startIndex,
...
void SignatureEngine::Evaluate(SignatureRecord& signature,
                               const std::vector<uint8_t>& mappedImage,
                               const PEInfo& pe, size_t rawFileSize,
                               OfflinePatternScanScope scope) const
{
...
ResolvedSignatureTarget SignatureEngine::Resolve(const SignatureRecord& signature,
...
std::string SignatureEngine::FormatPattern(const std::vector<PatternByte>& pattern)
{
