...
std::vector<FunctionInfo> functions::DiscoverFunctions(const uint8_t* data, size_t dataSize,
...
std::vector<FunctionInfo> functions::DiscoverFunctionsFromXRefs(const std::vector<FunctionInfo>& existing,
...
std::vector<FunctionInfo> functions::DiscoverFunctionsFromPE(const std::vector<FunctionInfo>& existing,
                                                             uint64_t entryPoint,
...
std::vector<FunctionInfo> functions::DiscoverFunctionsFromRuntimeFunctions(
...
std::vector<FunctionInfo> functions::DiscoverFunctionsFromSymbols(
...
FunctionInfo functions::AnalyzeFunction(const uint8_t* data, size_t dataSize,
...
std::string functions::GenerateAssemblySummary(const FunctionInfo& func, bool is64Bit)
{
